...
<p>IMPORTANT: later versions of cssSweet contain some potentially <strong>breaking changes</strong> from version 1.x, in specific use cases. If you are upgrading from version 1.x please ensure you read the <a href="http://sepiariver.github.io/cssSweet/">documentation</a> carefully, and backup your site before performing this upgrade. Upgrading from 2.x to 3.x or to 4.x should be fairly problem-free but a lot has changed so make sure you've backed up everything before continuing...</p>
<br />
