...
if (empty($csssCustomJsPath)) {
    $csssCustomJsPath = $modx->getOption('assets_path') . 'components/csssweet/' . $mode . '/js/';
}
...
if (file_exists($file) && is_readable($file)) {
    $modx->log(modX::LOG_LEVEL_INFO, 'Minification was ' . $status . ' performed. Custom JS saved to file: ' . $file);
}
