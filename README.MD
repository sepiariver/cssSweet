...
1. It's best to put your customized properties into a new property set, so that they won't be overwritten on install. In this case, ensure the Events are triggered using your custom property sets. Check the "System Events" tab in the Plugin Edit View.
